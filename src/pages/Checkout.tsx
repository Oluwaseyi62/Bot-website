...
const Checkout: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const order: Order = {
      ...
      items: [...items],
      totalAmount,
      paymentProofName: formData.paymentProof?.name || '',
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="p-6 bg-white rounded-lg">
              ...
              <div className="mb-8 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border ${errors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black`}
                  />
                  {errors.fullName && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black`}
                  />
                  {errors.email && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full border ${errors.phone ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black`}
                  />
                  {errors.phone && (
              ...
              <div className="mb-8 space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500">We'll deliver your order to your address</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500">Pick up your order at our store location</p>
                  </div>
                </div>
                ...
                {formData.deliveryOption === 'delivery' && (
                  <div className="mt-4">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={3}
                      className={`w-full border ${errors.address ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black`}
                    ></textarea>
                    {errors.address && (
              ...
              <div className="p-4 mb-6 rounded-md bg-gray-50">
                ...
                <p className="mb-1"><span className="font-medium">Bank:</span> {bankDetails.bankName}</p>
                <p className="mb-1"><span className="font-medium">Account Name:</span> {bankDetails.accountName}</p>
                <p><span className="font-medium">Account Number:</span> {bankDetails.accountNumber}</p>
              </div>
              
              <div className="mb-8">
                <p className="mb-4 text-sm text-gray-700">
                  Please transfer the total amount to the bank account details provided above. 
                  After making the payment, upload a screenshot or PDF of your payment confirmation below.
                </p>
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center justify-center px-6 pt-5 pb-6 mt-1 border-2 border-gray-300 border-dashed rounded-md">
                    {filePreview ? (
                      <div className="w-full text-center">
                        <img src={filePreview} alt="Payment proof" className="mx-auto mb-2 max-h-48" />
                      ...
                      <div className="text-center">
                        ...
                        <div className="flex mt-2 text-sm text-gray-600">
                          <label htmlFor="file-upload" className="relative font-medium text-black rounded-md cursor-pointer hover:text-gray-700">
                  ...
                  {errors.paymentProof && (
                    <p className="mt-1 text-sm text-red-500">{errors.paymentProof}</p>
                  )}
                </div>
              </div>
            ...
            <div className="sticky p-6 rounded-lg bg-gray-50 top-24">
              ...
              <div className="pt-4 mb-6 border-t border-gray-200">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span>{formData.deliveryOption === 'delivery' ? '$5.00' : 'Free'}</span>
                </div>
